...
function DashboardController($scope, $http) {
    ...
    ctrl.getAllProducts = function () {
        ctrl.productUrl = "https://api.efood.real.de/api/v2/real/products/search?query=" + ctrl.searchText + ":" + ctrl.sort + ":" + ctrl.category + "&currentPage=" + ctrl.currentPage + "&pageSize=" + ctrl.pageSize;
